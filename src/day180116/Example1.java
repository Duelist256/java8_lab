...
public class Example1 {
    public static void main(String[] args) throws NoSuchFieldException, NoSuchMethodException {
        ...
        ParameterizedType indexedStringType =
                (ParameterizedType) indexedString.getClass().getGenericSuperclass();
        ...
        ParameterizedType listFieldType =
                (ParameterizedType) IndexedString.class.getDeclaredField("list").getGenericType();
        System.out.println(listFieldType.getActualTypeArguments()[0]);

        ParameterizedType staticMethodReturnType =
                (ParameterizedType) IndexedString.class.getDeclaredMethod("staticGenericList").getGenericReturnType();
        System.out.println(staticMethodReturnType.getActualTypeArguments()[0]);

        ParameterizedType nonStaticMethodReturnType =
                (ParameterizedType) IndexedString.class.getDeclaredMethod("nonStaticGenericList").getGenericReturnType();
